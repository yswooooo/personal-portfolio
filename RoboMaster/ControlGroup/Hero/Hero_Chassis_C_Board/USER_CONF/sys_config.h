...
#define CHASSIS_KB_MOVE_RATIO_X 0.9f//1.0f //键盘速率
/* 前后 速度 (mm/s) */
#define CHASSIS_KB_MAX_SPEED_Y  4000.0f
#define CHASSIS_KB_MOVE_RATIO_Y 0.8f//1.0f
...
/* 遥控模式 云台速度控制 */
/* pitch 轴 速度 */
#define GIMBAL_PC_MOVE_RATIO_PIT 1.0f //遥控器速率
/* yaw 轴 速度 */
...
/*轮距（左右）*/
#define WHEELTRACK             376//二代英雄底盘
/*轴距（前后）*/
#define WHEELBASE              455//二代英雄底盘
...
/*小陀螺转速*/
#define LG_SPEED	210//300 测试参数：压降5V——50s 40W:178 45W:190 50W:202  5V——70s  55W:216 60W:225 65W:245 
/*小陀螺或小猫步下最大VW*/
...
#define LOADER_CAN1          CAN1
#define TRIG_CAN2					CAN2

#define POWER_CAN         CAN1
#define SUPER_CAP_CAN     CAN1

#define SERVANT_CAN 			CAN2
