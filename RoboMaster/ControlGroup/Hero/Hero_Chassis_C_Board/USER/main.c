...
int main(void)
{
  ...
  pc_tx_param_init();
	...
	GPIO_SetBits(GPIOH,GPIO_Pin_12);GPIO_ResetBits(GPIOH,GPIO_Pin_10|GPIO_Pin_11);//红灯
	while(BMI088_init(IMU_Cali_Flag)){}
	GPIO_SetBits(GPIOH,GPIO_Pin_11);GPIO_ResetBits(GPIOH,GPIO_Pin_10|GPIO_Pin_12);//灭红蓝//IMU初始化完成亮绿灯
