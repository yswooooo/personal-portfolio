...
// 舵轮已迁移至 app_steer_chassis.c + bsp_can_robostride.c，本文件保留 LD2-RS 二轮差速逻辑
...
/**
  * @brief  遥控设置Emergency急停标志位——>SW[A] == MID——>Emergency_Flag = 0;
  * @param  channels 遥控通道数据指针
  */
extern uint8_t g_emergency_stop_flag;
void app_rc_channels_set_emergency_flag(RC_Channels_t* channels)
{
	if(channels->sw_val[eRC_SW_A]==eRC_POS_UP)
    {
