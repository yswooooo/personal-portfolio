...
#define TEST_PIN_FOR_SCOPE_Pin GPIO_PIN_0
#define TEST_PIN_FOR_SCOPE_GPIO_Port GPIOA
#define KEY_STOP_Pin GPIO_PIN_15
#define KEY_STOP_GPIO_Port GPIOA
#define KEY_STOP_EXTI_IRQn EXTI15_10_IRQn
