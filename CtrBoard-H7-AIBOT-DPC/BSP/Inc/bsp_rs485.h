...
typedef struct {
    ...
    /* 状态机 */
    volatile bsp_rs485_state_t state; /**< 当前状态                      */
    ...
    volatile uint16_t   rx_len;     /**< IDLE 中断填入实际长度          */
    volatile uint64_t   rx_timestamp_us; /**< IDLE 中断接收时间戳        */
...
/**
  * @brief 取消当前异步事务并安全释放总线
  * @note  仅供拥有当前事务的高优先级安全路径使用。
  */
