...
```text
build/
  CtrBoard-H7-AIBOT-DPC.elf
  CtrBoard-H7-AIBOT-DPC.map
  CtrBoard-H7-AIBOT-DPC.hex
  CtrBoard-H7-AIBOT-DPC.bin
  obj/
...
```powershell
cd D:\Internship\TsingHuaSZ-AI-Robot-LAB\CtrBoard-H7-AIBOT-DPC\CtrBoard-H7-AIBOT-DPC
```
...
- Uses `MDK-ARM/CtrBoard-H7-AIBOT-DPC.uvprojx`.
